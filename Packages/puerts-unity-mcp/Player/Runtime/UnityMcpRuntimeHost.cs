...
namespace PuertsUnityMcp
{
    public sealed partial class UnityMcpRuntimeHost : MonoBehaviour, IUnityMcpEndpoint
    {
        ...
        {
            if (IsDisabledByEnvironment() || Instance != null)
            {
                return false;
            }
        ...
        private void Initialize()
        {
            ...
            ApplyRuntimeConfig(UnityMcpRuntimeConfigStore.Load());
        ...
        {
            if (settings == null || !settings.mcpEnabled || httpServer != null)
            {
                return;
            }
        ...
        {
            if (Application.isEditor || !lanDiscoveryEnabled || discoveryService != null || httpServer == null)
            {
                return;
            }
